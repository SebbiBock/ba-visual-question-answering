...
def convert_edf_to_dataframe(participant_string: str):
    """
        Converts the edf file created for the given participant string and converts it to asc (ASCII) using the edf2csv
        command from the EyeLink Developer Kit (which therefore needs to be installed).
